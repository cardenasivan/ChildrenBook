...
- (BOOL)requestRedirectedToRequest:(NSURLRequest *)redirectedRequest {
  ...
  NSString *redirectURI = self.authentication.redirectURI; //JON https://www.google.com/OAuthCallback
  ...
  NSURL *redirectURL = [NSURL URLWithString:redirectURI]; //JON https://www.google.com/OAuthCallback
  NSURL *requestURL = [redirectedRequest URL]; //JON: https://www.google.com/OAuthCallback#access_token=...
  ...
  if (!self.hasHandledCallback) {
    NSLog(@"XXX GOT %@ ",[[redirectedRequest URL] query] );
    NSLog(@"XXXY GOT %@ ",[[redirectedRequest URL] parameterString]);      
    NSLog(@"ZZZ GOT %@ ",[redirectedRequest URL] );            
    NSLog(@"XQ GOT %@", [[redirectedRequest URL] fragment]);
      /* access_token=00D80000000KwMC%21AR8AQLa.plSE1hf8FY_LMhWgwOBPm0qBnwRMhYrZt80eYUNQu7Al51llkhhr39rhVRAskqFnox7f7h5zTEgU_Wbzv3_cjI.t&instance_url=https%3A%2F%2Fna8.salesforce.com&id=https%3A%2F%2Flogin.salesforce.com%2Fid%2F00D80000000KwMCEA0%2F00580000001Yj8bAAC&issued_at=1306675635338&signature=Nnd8yvizwdkV1rILY92SQyAAK8uXib0bNPL16upzgR0%3D */
      //JON
      
      NSString * foo = [[redirectedRequest URL] absoluteString];     
      NSString * access_token = [[foo substringToIndex: [foo rangeOfString:@"&instance_url"].location] substringFromIndex:12];
      NSLog(@"access token=%@", access_token );
      
      NSString * instance_url = [[foo substringToIndex: [foo rangeOfString:@"&id="].location] substringFromIndex:[foo rangeOfString:@"instance_url"].location+12];
      NSLog(@"Instance URL=%@", instance_url);
      
      
      NSURL *x = [NSURL URLWithString:instance_url] ;
      
      NSLog(@"URL %@", x);

      NSLog(@"Absolute string %@", [foo stringByReplacingOccurrencesOfString:@"#" withString:@"?"]);
      
      
    //JON: This is the original NSString *responseStr = [[redirectedRequest URL] query];
      
      NSString *responseStr = [[NSURL URLWithString:[foo stringByReplacingOccurrencesOfString:@"#" withString:@"?"]] query];
